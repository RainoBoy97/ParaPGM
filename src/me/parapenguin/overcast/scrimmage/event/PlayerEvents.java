...
public class PlayerEvents implements Listener {
	...
	public void onPlayerJoin(PlayerJoinEvent event) {
		...
		if (Scrimmage.isPublic()) player.sendMessage(ChatColor.DARK_AQUA + "Public Scrimmage Server: " + ChatColor.GOLD + "#" + Scrimmage.getID());
		else player.sendMessage(ChatColor.GOLD + Scrimmage.getTeam() + ChatColor.DARK_AQUA + "'s Private Scrimmage Server");
	...
	public void onServerListPing(ServerListPingEvent event) {
		...
		String team = "";
		if (!Scrimmage.isPublic()) team = ChatColor.GRAY + "(" + ChatColor.GOLD + Scrimmage.getTeam() + ChatColor.GRAY + ")";
	...
	public void onPlayerRespawn(PlayerRespawnEvent event) {
		...
		if (!client.getTeam().isObserver() && spawn.getKit() != null) spawn.getKit().load(client);
	...
	public void onEntityDamageEvent(EntityDamageByEntityEvent event) {
		...
		if (event.getDamager() instanceof Player == false && event.getDamager() instanceof Projectile == false) return;
		...
		if (event.getDamager() instanceof Projectile) {
			...
			if (proj.getShooter() instanceof Player == false) return;
		...
		if (attacker.getTeam() == damaged.getTeam() || attacker.isObserver() || damaged.isObserver()) event.setCancelled(true);
	}
